...
app.get('/health', async (req,res)=>{
  ...
  res.json({ ok:true, version:VERSION, storageDriver:STORAGE_DRIVER, pricing:'1GB=1EUR', node:process.version, r2Mode:'railway-worker-proxy-clean-ui-with-assets', workerReady: !!(WORKER_URL && WORKER_SHARED_SECRET && workerPing), workerUrlSet: !!WORKER_URL, workerSecretSet: !!WORKER_SHARED_SECRET, workerPing, ui:'assets-hard-fixed' });
});
